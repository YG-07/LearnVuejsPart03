...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_709c3ca2_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Cpn_vue__ = __webpack_require__(18);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var render = function() {
  ...
  return _c("div", [
    _c("h2", { staticClass: "title" }, [
      _vm._v("这是“" + _vm._s(_vm.name) + "”组件标题")
    ]),
    _vm._v(" "),
    _c("p", [_vm._v("这是cpn组件的内容，哈哈哈")])
  ])
}
var staticRenderFns = []
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("h2", { staticClass: "title" }, [
        _vm._v("这是App组件，" + _vm._s(_vm.message))
      ]),
      _vm._v(" "),
